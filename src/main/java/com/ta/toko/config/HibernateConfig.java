...
public class HibernateConfig {
	...
	private Properties additionalProperties() {
		...
		// "org.hibernate.dialect.SQLServer2012Dialect");//org.hibernate.dialect.MySQLDialect
	...
	public DataSource basicDataSource() {
		...
		dataSource.setPassword("root");// Admin@3456
		// dataSource.setValidationQuery("SELECT 1;");
		// dataSource.setUrl("jdbc:sqlserver://localhost:1433;databaseName=kupalatu_store");
		dataSource.setUrl("jdbc:mysql://192.168.0.119:3306/kupalatu_store");
		// dataSource.setDriverClassName("com.microsoft.sqlserver.jdbc.SQLServerDriver");com.mysql.jdbc.Driver
