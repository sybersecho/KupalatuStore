					...
					<div class="box box-info">
		                ...
		                <div class="box-body">
	                    	<div class="form-group">
	                    		<form:label path="tempPurcaseDetail.product.barcode" cssClass="col-sm-2 control-label">Barcode</form:label>
                      			<div class="col-sm-10">
                        			<form:input path="tempPurcaseDetail.product.barcode" cssClass="form-control" placeholder="Barcode"/>
                      				<form:errors path="tempPurcaseDetail.product.barcode" class="control-label" />
	                      		</div>
	                    	</div>
		                </div><!-- /.box-body -->
